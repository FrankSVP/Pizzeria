...
@section('content')
<h1 class="h3 mb-4 text-gray-800">Tipos de Usuario</h1>

<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Listado de Tipos de Usuario</h6>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="tipousuario" class="form-control" required>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <form action="{{ route('tipousuario.update', $tipo->id) }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="tipousuario{{ $tipo->id }}">Tipo</label>
                        <input type="text" name="tipousuario" class="form-control" id="tipousuario{{ $tipo->id }}" value="{{ $tipo->tipousuario }}" required>
                    </div>
                    <input type="hidden" name="activo" value="0">
                    <div class="form-group form-check">
...
<div class="modal fade" id="modalEliminarTipo{{ $tipo->id }}" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form action="{{ route('tipousuario.destroy', $tipo->id) }}" method="POST">
            @csrf
            @method('DELETE')
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ¿Estás seguro de que deseas eliminar <strong>{{ $tipo->tipousuario }}</strong>?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
